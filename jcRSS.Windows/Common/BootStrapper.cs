...
namespace jcRSS.WindowsUniversal.Common {
    public abstract class BootStrapper : Application {
        public event EventHandler<global::Windows.UI.Core.BackRequestedEventArgs> BackRequested;
        ...
        private async void InternalLaunchAsync(ILaunchActivatedEventArgs e) {
            ...
            this.RootFrame.Language = global::Windows.Globalization.ApplicationLanguages.Languages[0];
            ...
            global::Windows.UI.Core.SystemNavigationManager.GetForCurrentView().BackRequested += OnBackRequested;
        }

        private void OnBackRequested(object sender, global::Windows.UI.Core.BackRequestedEventArgs e) {
